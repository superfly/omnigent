...
async def _run_sprite_activity_lease(
    *,
    ...
    The local Tasks API prevents idle suspension during a turn. A short lease
    is refreshed while work remains active and released as soon as it drains;
    expiry is the crash-safe cleanup path.
    """
